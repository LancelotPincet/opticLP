...
Here, we want to create a new Python project with a dependency on **opticLP**.
...
.. tab-set::
   ...
   .. tab-item:: Anaconda tools (Spyder Jupyter)
      ...
      To be able to use another virtual environment, *Spyder* and *Jupyter* connects to specific kernels, respectively *spyder-kernels* and *ipykernel*, which are included in **opticLP** library dependencies.
...
To finish, some routines may be provided with the library **opticLP** :doc:`(see Reference Guide) <routines>`.
To use them, you can just download `routines source codes <https://github.com/LancelotPincet/opticLP/tree/main/src/opticlp/routines>`_.
...
.. dropdown:: Using *Anaconda* distribution
   ...
   *Anaconda* is a Python distribution designed for scientific programming.
   ...
   Here we will explain how to setup up virtual environments dependent on **opticLP** that you will be able to use on various projects.
   ...
   However some dependencies for this Python project might not be available in this *base* environment, like **opticLP**.
   ...
   - create venv: ``conda create -n venv_opticLP python``
   - activate venv: ``conda activate venv_opticLP``
   - update pip: ``conda install pip``
   - add *Spyder* and *Jupyter* kernels: ``conda install spyder-kernels ipykernel``
   - install **opticLP**: ``pip install opticlp``
...
.. dropdown:: Manual project
   ...
   6. Install **opticLP** from terminal: ``pip install opticlp``
...
If ever you want to play with the library source code, to apply your own modifications, or even to contribute, you can access it on the `GitHub page <https://github.com/LancelotPincet/opticLP>`_.
...
Now, you can clone in your current directory the `source code folder <https://github.com/LancelotPincet/opticLP>`_ with the following command
