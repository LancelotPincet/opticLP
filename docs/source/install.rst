...
To finish, some scripts may be provided with the library **opticLP** :doc:`(see Reference Guide) <scripts>`.
To use them, you can just download `scripts source codes <https://github.com/LancelotPincet/opticLP/tree/main/src/opticlp/scripts>`_.
