...
- The library is organized under `src/opticlp` into two main parts:
...
- The main object is defined in:
  - `myname.py`
  - and imported as: `from opticlp import myname`
...
- All such objects become importable from the package root directly with ```from opticlp import myname```.
